...
import "../external/ERC20Mintable.sol";
 ...
 */
contract MockYieldSource is ERC20Mintable, IYieldSource {
    ERC20Mintable public token;

    constructor(
        address minter,
        address burner
    ) ERC20Mintable(minter, burner) {
        token = new ERC20Mintable(minter, burner);
    }
