...
contract yieldSourceA is IYieldSource {
    ...
    IERC20(assetToken).mint(address(this), amount);
    }
    ...
    {   
        return IERC20(assetToken).balanceOf(addr);
    ...
    function supplyTokenTo(uint256 amount, address to) external override{
        IERC20(assetToken).transferFrom(to,address(this),amount);
